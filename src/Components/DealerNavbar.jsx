      ...
      <Container>
        ...
        <Navbar.Collapse id="responsive-navbar-nav" className={isOpen ? 'show' : ''}>
          ...
          <NavDropdown title="My Account" id="basic-nav-dropdown">
            ...
            <NavDropdown.Item href={`\DealersProfile?UserId=${users}`} style={{ textAlign: "center" }}>My Profile</NavDropdown.Item>
    ...
    <Navbar bg="light" variant="light" expand="lg">
      ...
      <Navbar.Collapse id="basic-navbar-nav">
        ...
        {/* <NavDropdown title="Category" id="basic-nav-dropdown">
          ...
          <Nav.Link href="\DealersHome">Home</Nav.Link>
          <Nav.Link href="\DealerCart">Cart</Nav.Link>
          <Nav.Link href="\DealerOrders">Orders</Nav.Link>
          <Nav.Link href="\DealerStock">Stock</Nav.Link>
          <Nav.Link href="\DealerThreshold">Threshold</Nav.Link>
          <Nav.Link href="\DealerReports">Reports</Nav.Link>
        </Nav>
      </Navbar.Collapse>
    </Navbar>
    </div>
...
//       <a class="navbar-brand mt-2 mt-lg-0" href="\DealersHome">
        
//       </a>
//       <ul class="navbar-nav me-auto mb-2 mb-lg-0">
//       <div class="container-fluid">
//         <span class="navbar-brand mb-0 h1">Dealer's Portal</span>
//       </div>
//         <li class="nav-item">
//           <a class="nav-link" href="\DealersHome">Home</a>
//         </li>
//         <li class="nav-item">
//           <a class="nav-link" href="\DealerCart">Cart</a>
//         </li>
//         <li class="nav-item">
//           <a class="nav-link" href="\DealerOrders">Orders</a>
//         </li>
//         <li class="nav-item">
//           <a class="nav-link" href="\DealerStock">Stock</a>
//         </li>
//         <li class="nav-item">
//           <a class="nav-link" href="\DealerThreshold">Threshold</a>
//         </li>
//       </ul>
//     </div>
...
//         >
//           <li>
//             <a class="dropdown-item" href={`\DealersProfile?UserId=${users}`}>My profile</a>
//           </li>
//           <li>
