  ...
  export default function CustomerOrders() {
    ...
    useEffect(()=>{
        ...
        async function fetchData() {
          try {
            const response = await fetch(`https://majestic-clever-grapple.glitch.me/GetOrderofUserIdCustomer?UserId=${localStorage.getItem('UserId')}`);
      ...
      {Product.map((prof,index)=>(
                  ...
                  >
                    <MDBRow>
                      ...
                      <button onClick={()=>{setShow(true);setProductId(prof.ProductId);setReview('');localStorage.setItem("DealerId", prof.DealerId);}} type="button" size="sm" className="btn bg-warning btn-block mb-4 mt-20"
      ...
      >
        ...
        <Modal
          ...
          >
            ...
            <form action={`https://majestic-clever-grapple.glitch.me/DealerReviewAndRating?rating=${rating}&ProductId=${ProductId}&UserId=${localStorage.getItem('UserId')}&DealerId=${localStorage.getItem('DealerId')}`} method="post" id="formreview">
